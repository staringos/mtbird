  ...
  return (
    <div className={styles.userList}>
      {onlineUserList.map((cur: IUser, i: number) => {
        return (
          <Tooltip placement="bottom" title={cur.nickname} key={i} placement="left">
            <Dropdown menu={{ items }}>
              <Avatar className={styles.userListAvatar} src={cur.avatar || 'https://mtbird-cdn.staringos.com/product/assets/logo.ico.png'} />
            </Dropdown>
          </Tooltip>
        );
      })}
