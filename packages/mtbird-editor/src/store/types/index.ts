...
import { IState as IExtensionState, IAction as IExtensionAction } from './extension';
...
export interface IContextState extends IExtensionState, IPageState, ICommonState {
  loading: boolean;
}
export interface IContextAction extends IExtensionAction, IPageAction, ICommonAction {}
