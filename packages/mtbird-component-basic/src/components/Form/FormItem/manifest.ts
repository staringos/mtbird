...
import { generateFormItem, generateFormItemSelect, generateInputComponent } from '../../../utils';
import { COMPONENT } from '@mtbird/core';

const { SCHEMA_CONTAINER_BASIC_STYLE, BUTTON_FORM_COMPONENT_NAME_OPTIONS } = COMPONENT;
...
const manifest: IComponentManifest<IComponentInstanceForm> = {
  ...
  schema: [
    ...
    generateFormItemSelect('formConfig.componentName', '表单类型', BUTTON_FORM_COMPONENT_NAME_OPTIONS),
    generateFormItem('字段名', null, [generateInputComponent('formConfig.keyPath')])
  ],
  category: 'form',
  instance: {
    type: 'form',
